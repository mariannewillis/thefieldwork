...
export const about = {
  ...
  practice: {
    plate: {
      ...
      alt: "Her two hands held at the edge of a low pool of gold light, the rest of the room in shadow.",
      b: 0.5,
      ox: "50%",
      oy: "50%",
    } satisfies Plate,
  ...
  person: {
    ...
    plate: {
      ...
      alt: "Her practice room at dusk, a warm pool of lamplight lying across the floor, no one in the frame.",
      b: 0.42,
      ox: "58%",
      oy: "54%",
    } satisfies Plate,
