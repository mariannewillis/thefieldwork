...
import { bookingReference, type BookingWithWorkshop } from "@/lib/bookings";
...
function Booked({ booking }: { booking: BookingWithWorkshop }) {
        ...
        <div className="pool on-pool px-7 py-8 sm:px-9">
          ...
          {deadline ? (
            <p className="mt-3 text-[17px] leading-relaxed text-ink">
              ...
              and you get the full {formatMoney(booking.amountPence)} back.
              After that the place is held for you and cannot be refunded.
            </p>
          ) : (
            <p className="mt-3 text-[17px] leading-relaxed text-ink">
